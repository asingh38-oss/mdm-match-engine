...
def make_strong_match():
    """Helper: all high scores → strong match"""
    return {
        ...
        "level5": {"confidence": 95}
    }


def make_weak_match():
    """Helper: all low scores → weak match"""
    return {
        ...
        "level5": {"confidence": 10}
    }


def make_middle_match():
    """Helper: medium scores → potential match"""
    return {
